...
md ..\x64\Release\config
copy ..\StuntrallyConfig\cars.xml ..\x64\Release\config
copy ..\StuntrallyConfig\challenges.xml ..\x64\Release\config
copy ..\StuntrallyConfig\championships.xml ..\x64\Release\config
copy ..\StuntrallyConfig\colors.ini ..\x64\Release\config

copy ..\StuntrallyConfig\editor-default.cfg ..\x64\Release\config
copy ..\StuntrallyConfig\game-default.cfg ..\x64\Release\config
copy ..\StuntrallyConfig\presets.xml ..\x64\Release\config

copy ..\StuntrallyConfig\resources.cfg ..\x64\Release\config
copy ..\StuntrallyConfig\resources_ed.cfg ..\x64\Release\config
copy ..\StuntrallyConfig\resources_s.cfg ..\x64\Release\config
copy ..\StuntrallyConfig\resources_s_ed.cfg ..\x64\Release\config
copy ..\StuntrallyConfig\tracks.ini ..\x64\Release\config